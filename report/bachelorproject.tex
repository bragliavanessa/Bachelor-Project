...
\end{equation}
%In the general case, the multiplicity of the the first eigenvalue corresponds to the number of connected components of the graph and the eigenvalues read $0 = \lambda_1 = \ldots = \lambda_m < \lambda_{m+1} \le \ldots \lambda_n$.
